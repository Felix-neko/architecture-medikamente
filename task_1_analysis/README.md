...
* Администратор открывает журнал записей на заданную дату (xlsx-файл в сетевой папке по пути /Записи/{дата\_записи}/{имя\_специалиста}.xslx), ищет окно в расписании у заданного специалиста – и вносит туда ФИО пациента.  
